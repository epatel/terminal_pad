...
### Features
> All features are documented in their co-located `src/<feature>/CLAUDE.md` (auto-discovered): **canvas**, **viewport**, **render**, **editing**, **locations**, **persistence**, **overview**, **help**. No feature cards live here.
